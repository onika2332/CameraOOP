...
public class BoxLength3D_F32 implements Serializable {
	...
	public void setTo(BoxLength3D_F32 orig ) {
		setTo(orig.p.x,orig.p.y,orig.p.z,orig.lengthX,orig.lengthY,orig.lengthZ);
	}

	public BoxLength3D_F32() {}

	public void setTo(float x0, float y0, float z0, float lengthX, float lengthY, float lengthZ) {
		this.p.setTo(x0,y0,z0);
		this.lengthX = lengthX;
		this.lengthY = lengthY;
		this.lengthZ = lengthZ;
	 ...
	 * @return The corner.
	 */
	public Point3D_F32 getCorner(int index , @Nullable Point3D_F32 corner ) {
		if( corner == null )
