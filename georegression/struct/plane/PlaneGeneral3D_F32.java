 ...
 * @author Peter Abeles
 */
@Generated("georegression.struct.plane.PlaneGeneral3D_F64")
public class PlaneGeneral3D_F32 implements Serializable {
	...
	public void setTo(PlaneGeneral3D_F32 src ) {
		this.A = src.A;
		this.B = src.B;
		this.C = src.C;
		this.D = src.D;
	...
	public boolean equals(Object obj) {
		...
		if( !(obj instanceof PlaneGeneral3D_F32)) return false;
		var o = (PlaneGeneral3D_F32) obj;
		return Float.compare(o.A, A) == 0 &&
				Float.compare(o.B, B) == 0 &&
				Float.compare(o.C, C) == 0 &&
				Float.compare(o.D, D) == 0;
	}
