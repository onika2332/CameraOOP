...
public class Homography2D_F32 extends Matrix3x3_F32 implements Homography<Homography2D_F32>{
	...
	@Override
	public void setTo(Homography2D_F32 target) {
		super.set(target);
	}

	@Override
	public Homography2D_F32 concat(Homography2D_F32 second, @Nullable Homography2D_F32 ret) {
		if( ret == null )
	...
	@Override
	public Homography2D_F32 invert( @Nullable Homography2D_F32 ret) {
	    if( ret == null )
			ret = new Homography2D_F32();
	...
	public FMatrixRMaj ddrm( @Nullable FMatrixRMaj output ) {
		...
		FConvertMatrixStruct.convert(this,output);
		return output;
	}
