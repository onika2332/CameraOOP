 ...
 * @author Peter Abeles
 */
@Generated("georegression.struct.affine.Affine2D_F64")
public class Affine2D_F32 implements Affine<Affine2D_F32> {
	...
	public void setTo(float a11, float a12, float a21, float a22, float tx, float ty ) {
		this.a11 = a11;
		this.a12 = a12;
		this.a21 = a21;
		this.a22 = a22;
	...
	@Override
	public void setTo(Affine2D_F32 target ) {
		this.a11 = target.a11;
		this.a12 = target.a12;
		this.a21 = target.a21;
		this.a22 = target.a22;
	...
	@Override
	public Affine2D_F32 concat( Affine2D_F32 second, @Nullable Affine2D_F32 ret ) {
	...
	@Override
	public Affine2D_F32 invert( @Nullable Affine2D_F32 inverse ) {
		if( inverse == null )
